...
BOOST_AUTO_TEST_CASE(parse_address_test)
{
    ...
    check_bind("unix::max-connections=1", "unix:", 1, "");
    ...
    check_bind("unix::max-connections=0", "", 0, "max-connections must be at least 1");
    check_bind("unix::max-connections=-1", "", 0, "max-connections must be at least 1");
    check_bind("unix::max-connections=-9223372036854775808", "", 0, "max-connections must be at least 1");
    check_bind("unix::max-connections=2147483648", "", 0, "max-connections must be at most 2147483647");
